...
from test_patterns.behavioral import test_strategy, test_payment_strategy, test_state, test_phone_state, test_chain_of_responsibility, test_pipeline, test_iterator, test_yield_iterator, test_graph_iterator, test_visitor
